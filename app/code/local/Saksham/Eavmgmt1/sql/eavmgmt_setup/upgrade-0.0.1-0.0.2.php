...
$table = $installer->getConnection()
		->newTable($installer->getTable('eavmgmt/eav_attribute'))
    ...
    ->addIndex($installer->getIdxName('eavmgmt/eav_attribute', array('used_for_sort_by')),
        array('used_for_sort_by'))
    ->addIndex($installer->getIdxName('eavmgmt/eav_attribute', array('used_in_product_listing')),
        array('used_in_product_listing'))
    ->addForeignKey($installer->getFkName('eavmgmt/eav_attribute', 'attribute_id', 'eav/attribute', 'attribute_id'),
        'attribute_id', $installer->getTable('eav/attribute'), 'attribute_id',
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->setComment('Eavmgmt EAV Attribute Table');

    $query = "ALTER TABLE `eavmgmt_varchar` ADD UNIQUE( `attribute_id`, `store_id`, `entity_id`)";
...
$setup->addAttribute(Saksham_Eavmgmt_Model_Resource_Eavmgmt::ENTITY, 'firstname', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'firstname',
    ...
    'global'                     => Saksham_Eavmgmt_Model_Resource_Eav_Attribute::SCOPE_STORE,

));

$setup->addAttribute(Saksham_Eavmgmt_Model_Resource_Eavmgmt::ENTITY, 'lastname', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'lastname',
...
$setup->addAttribute(Saksham_Eavmgmt_Model_Resource_Eavmgmt::ENTITY, 'email', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'email',
...
$setup->addAttribute(Saksham_Eavmgmt_Model_Resource_Eavmgmt::ENTITY, 'phoneNo', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'phoneNo',
