...
class Saksham_Eavmgmt_Block_Adminhtml_Eavmgmt_Attribute_Grid extends Mage_Eav_Block_Adminhtml_Attribute_Grid_Abstract
{	
	...
	protected function _prepareColumns()
    {
        ...
        $this->addColumnAfter('entity_type_id',
            array(
