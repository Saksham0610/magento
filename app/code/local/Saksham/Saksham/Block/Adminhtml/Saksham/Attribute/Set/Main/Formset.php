<?php
class Saksham_Saksham_Block_Adminhtml_Saksham_Attribute_Set_Main_Formset extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('set_name', array('legend'=> Mage::helper('saksham')->__('Edit Set Name')));
        $fieldset->addField('attribute_set_name', 'text', array(
            'label' => Mage::helper('saksham')->__('Name'),
            'note' => Mage::helper('saksham')->__('For internal use.'),
        ...
        if( !$this->getRequest()->getParam('id', false) ) {
            ...
            $fieldset->addField('skeleton_set', 'select', array(
                'label' => Mage::helper('saksham')->__('Based On'),
                'name' => 'skeleton_set',
                'required' => true,
