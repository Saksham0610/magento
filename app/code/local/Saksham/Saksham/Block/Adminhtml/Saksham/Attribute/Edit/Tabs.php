    ...
    protected function _beforeToHtml()
    {
        ...
        /*if ('select' == $model->getFrontendInput()) {
            $this->addTab('options_section', array(
                'label'     => Mage::helper('saksham')->__('Options Control'),
                'title'     => Mage::helper('saksham')->__('Options Control'),
                'content'   => $this->getLayout()->createBlock('adminhtml/saksham_product_attribute_edit_tab_options')->toHtml(),
            ));
        }*/
