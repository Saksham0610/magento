...
class Saksham_Saksham_Adminhtml_Saksham_AttributeController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function validateAction()
    {
        ...
        $attribute = Mage::getModel('saksham/resource_eav_attribute')
        ...
        if ($data) {
            ...
            if (isset($data['attribute_code'])) {
                ...
                if (!$validatorAttrCode->isValid($data['attribute_code'])) {
                    $session->addError(
                        Mage::helper('saksham')->__('Attribute code is invalid. Please use only letters (a-z), numbers (0-9) or underscore(_) in this field, first character should be a letter. Do not use "event" for an attribute code.')
                    );
            ...
            if ($id) {
                ...
                if ($model->getEntityTypeId() != $this->_entityTypeId) {
                    $session->addError(
                        Mage::helper('saksham')->__('This attribute cannot be updated.'));
