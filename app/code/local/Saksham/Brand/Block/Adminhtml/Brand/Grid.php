<?php
class Saksham_Brand_Block_Adminhtml_Brand_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
   ...
   protected function _prepareCollection()
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('image', array(
            ...
            'align'     => 'left',
            'index'     => 'image',
            'renderer'  => 'Saksham_Brand_Block_Adminhtml_Brand_Grid_Renderer_Image'
        ));
